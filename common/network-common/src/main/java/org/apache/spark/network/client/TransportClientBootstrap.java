 ...
 * reasonable(合理的) to perform an expensive bootstrapping operation, as they often share a lifespan(生命周期) with
 * the JVM itself.
 */
/**
 * connections and TransportClients 可能会被reused,这通常是合理的,因为执行bootstrapping operation是比较昂贵,通常以JVM共享的方式来达到重用.
 * */
