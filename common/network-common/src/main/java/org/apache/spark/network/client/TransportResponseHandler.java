 ...
 */
/**
 * TransportResponseHandler扩展自MessageHandler,存在于TransportClient端处理来自服务器端的响应信息,响应是TransportClient的请求.
 * 它跟踪请求的列表和它们的回调函数.它是线程安全的.
 * */
public class TransportResponseHandler extends MessageHandler<ResponseMessage> {
  ...
  public void channelInactive() {
    if (numOutstandingRequests() > 0) {
      ...
      logger.error("Still have {} requests outstanding(未完成／显著的) when connection from {} is closed",
