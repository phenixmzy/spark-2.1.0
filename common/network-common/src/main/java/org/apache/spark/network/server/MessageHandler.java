...
/**
 * Handles either request or response messages coming off of(off of 从) Netty. A MessageHandler instance
 * is associated with a single Netty Channel (though it may have multiple clients on the same
 * Channel.)
 */
/**
 * 处理来自Netty的请求或响应信息.一个MessageHandler实体与单一的Netty Channel联系在一起.
 * */
